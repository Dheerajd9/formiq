...
const styles = StyleSheet.create({
  ...
  checkBtnDone: { backgroundColor: Colors.gym },
  checkText: { fontSize: FontSize.md, color: Colors.textTertiary },
  checkTextDone: { color: Colors.white, fontWeight: FontWeight.bold },
  prBanner: {
  ...
  prText: { fontSize: FontSize.xs, fontWeight: FontWeight.bold, color: '#B8860B' },
});
