...
const styles = StyleSheet.create({
  ...
  shareBtnText: { color: Colors.btnPrimaryText, fontWeight: FontWeight.semibold, fontSize: FontSize.sm },
  ...
  statCardAccent: { backgroundColor: Colors.btnPrimary, borderColor: Colors.btnPrimary },
  statEmoji: { fontSize: 20 },
  statValue: { fontSize: FontSize.xl, fontWeight: FontWeight.bold, color: Colors.textPrimary },
  statValueAccent: { color: Colors.btnPrimaryText },
